...
* 1 test at a time, fill in the code until the test passes.
  * Do what you need to do to get the test to pass.  No one is watching but you (for now :D ).
* After tests pass, you can refactor and clean the innards of the module to follow [good code design](http://www.principles-wiki.net/principles:start)!
